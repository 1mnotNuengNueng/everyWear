...
public class Promotion implements Serializable {
    ...
    public Set<?> getCoupons() { return this.coupons; }
    public void setCoupons(Set<?> coupons) { this.coupons = coupons; }
    public Set<PromotionCategory> getPromotionCategories() { return this.promotionCategories; }
    public void setPromotionCategories(Set<PromotionCategory> promotionCategories) { this.promotionCategories = promotionCategories; }
}